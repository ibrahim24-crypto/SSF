...
mixin _$PostModel {
  ...
  Map<String, String> get customDetails => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      customDetails: null == customDetails
          ? _value.customDetails
          : customDetails // ignore: cast_nullable_to_non_nullable
...
class _$PostModelImpl implements _PostModel {
  const _$PostModelImpl(
      ...
      required final Map<String, String> customDetails,
  ...
  final Map<String, String> _customDetails;
  @override
  Map<String, String> get customDetails {
    if (_customDetails is EqualUnmodifiableMapView) return _customDetails;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_customDetails);
  }
  ...
  @override
  String toString() {
    return 'PostModel(id: $id, authorId: $authorId, authorName: $authorName, title: $title, description: $description, category: $category, birthDate: $birthDate, images: $images, customDetails: $customDetails, status: $status, rejectionReason: $rejectionReason, upvotes: $upvotes, downvotes: $downvotes, commentCount: $commentCount, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._customDetails, _customDetails) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_customDetails),
      status,
      rejectionReason,
      upvotes,
      downvotes,
...
abstract class $ImageDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, String publicId, String status});
}
...
class _$ImageDataImpl implements _ImageData {
  const _$ImageDataImpl(
      {required this.url, required this.publicId, required this.status});
  ...
  @override
  String toString() {
    return 'ImageData(url: $url, publicId: $publicId, status: $status)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, url, publicId, status);
...
abstract class _ImageData implements ImageData {
  const factory _ImageData(
      ...
      required final String status}) = _$ImageDataImpl;
